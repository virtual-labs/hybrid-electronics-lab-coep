...
var shiftregister = function() {
	...
	this.resetCounter = function() {
		...
		document.getElementById("b0_shift_register").src = "images/lightbulb_up.png";
		document.getElementById("b0_text").value = "";

		document.getElementById("b1_shift_register").src = "images/lightbulb_up.png";
		document.getElementById("b1_text").value = "";

		document.getElementById("b2_shift_register").src = "images/lightbulb_up.png";
		document.getElementById("b2_text").value = "";

		document.getElementById("b3_shift_register").src = "images/lightbulb_up.png";
	...
	this.updatecounter = function() {
		...
		//alert(inputData>>>1);
		if(b[3] == true) {
			document.getElementById("b0_shift_register").src = "images/lightbulb1_up.png";
		...
		if(b[2] == true) {
			document.getElementById("b1_shift_register").src = "images/lightbulb1_up.png";
		...
		if(b[1] == true) {
			document.getElementById("b2_shift_register").src = "images/lightbulb1_up.png";
		...
		if(b[0] == true) {
			document.getElementById("b3_shift_register").src = "images/lightbulb1_up.png";
