	...
	this.switch_status = function(id,index)
	{
		...
		var previous_image = that.getName(document.getElementById(id).src);
			if(previous_image == "off")
			{
				...
				document.getElementById("a3_3_div").value="1";
			...
			else 
			{
				...
				document.getElementById("a3_3_div").value="0";
...
/*		if(y_bin[0] ==true)
			document.getElementById("y3_alu_logic").src = "lightbulb1_up.png"
		else
			document.getElementById("y3_alu_logic").src = "lightbulb_up.png"
		if(y_bin[1] ==true)
			document.getElementById("y2_alu_logic").src = "lightbulb1_up.png"
		else
			document.getElementById("y2_alu_logic").src = "lightbulb_up.png"
		if(y_bin[2] ==true)
			document.getElementById("y1_alu_logic").src = "lightbulb1_up.png"
		else
			document.getElementById("y1_alu_logic").src = "lightbulb_up.png"
		if(y_bin[3] ==true)
			document.getElementById("y0_alu_logic").src = "lightbulb1_up.png"
		else
			document.getElementById("y0_alu_logic").src = "lightbulb_up.png"
*/	}
}
	...
	this.deciToBin1 = function(arg)
{
	...
	this.calculate = function ()
	{
		...
		//alert(" y_bin[3] : " +y_bin[3]);
		//alert(" y_bin[3] : " +y_bin[2]);
		//alert(" y_bin[3] : " +y_bin[1]);
		//alert(" y_bin[3] : " +y_bin[0]);
		//console.log(b[3]+"  "+b[2]+"  "+b[1]+"  "+b[0])
		//alert(b)
		$("#a_a").html("A: "+a);
		$("#b_a").html("B: "+b);
		...
		if(carry == 1) alert(carry + "  "+typeof(carry));
