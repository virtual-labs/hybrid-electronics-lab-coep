	...
	this.deciToBin = function(arg)
{
	...
	this.calculate = function ()
	{
		...
		$("#y_l").html("Y: "+y);
	//alert(""+y_bin)
		document.getElementById("glow3").src = y_bin[0] == true ? "images/lightbulb1_up.png" : "images/lightbulb_up.png";
		document.getElementById("glow2").src = y_bin[1] == true ? "images/lightbulb1_up.png" : "images/lightbulb_up.png";
		document.getElementById("glow1").src = y_bin[2] == true ? "images/lightbulb1_up.png" : "images/lightbulb_up.png";
		document.getElementById("glow0").src = y_bin[3] == true ? "images/lightbulb1_up.png" : "images/lightbulb_up.png";
	}
}
	...
	this.deciToBin1 = function(arg)
{
	...
	this.calculate = function () {
		...
		$("#b_a").html("B: "+b);
		$("#y_arith").val(bin);
		document.getElementById("glow4").src = y_bin[0] == true ? "images/lightbulb1_up.png" : "images/lightbulb_up.png";
		document.getElementById("glow5").src = y_bin[1] == true ? "images/lightbulb1_up.png" : "images/lightbulb_up.png";
		document.getElementById("glow6").src = y_bin[2] == true ? "images/lightbulb1_up.png" : "images/lightbulb_up.png";
		document.getElementById("glow7").src = y_bin[3] == true ? "images/lightbulb1_up.png" : "images/lightbulb_up.png";
		document.getElementById("y_alu_carry").src = (carry == "1" ? "images/lightbulb1_up.png" : "images/lightbulb_up.png");		
 ...
 $(document).ready(function(){ 
    ...
    $("#run_button_arith").click(function (){
		...
		$("#reset_button_arith").click(function (){
			document.getElementById("cin_12").src="images/on.png";
			document.getElementById("cin_12").value=1;
			obj_alu_arithmetic.switch_status("cin_12");
			for(var i=0;i<=3;i++){
				//alert("a_"+i+"_"+i);
				document.getElementById("at"+i+"_"+i).src="images/on.png";
			...
			for(var i=0;i<=3;i++){
				//alert("a_"+i+"_"+i);
				document.getElementById("b"+i+"_"+j).src="images/on.png";
			...
			for(var i=0;i<=3;i++){
				//alert("a_"+i+"_"+i);
				document.getElementById("s"+i+"_"+j).src="images/on.png";
				document.getElementById("s"+i+"_"+j+"_text").value=1;
				obj_alu_arithmetic.switch_status("s"+i+"_"+j);
				j++;
			}
			
			document.getElementById("y_alu_carry").src="images/lightbulb_up.png";
			for(var i=4;i<=7;i++){
				document.getElementById("glow"+i).src="images/lightbulb_up.png";
			}
	...
	//alu_logic
	{
		...
		$("#reset_button").click(function (){
			for(var i=3;i>=0;i--){
				//alert("a_"+i+"_"+i);
				document.getElementById("a"+i+"_"+i).src="images/on.png";
