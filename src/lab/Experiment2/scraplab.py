...
breadcrumb='<a href="http://vlabs.ac.in/electronics-and-communications-labs.html" class="sidebar-a" >Electronics & Communications</a> &rarr;<a href="../Introduction.html" class="sidebar-a" >'+heading1+'</a>&nbsp&rarr;<a href="../List of experiments.html" class="sidebar-a" >List Of Experiments</a><br/>'
while sectionNumber<=len(sectionno):
	...
	if tag1=='Prerequisite S/W':
		tag1='Prerequisites'
	st+='<a href="'+tag1+'.html?domain=ElectronicsandCommunications&lab='+heading1+'" class="sidebar-a" > <h3 class="text-h3-darkblue" style="margin-top: 2px;">'+tag1+'</h3></a>'	
	sectionNumber=sectionNumber+1
st+='<a href="Feedback.html?domain=ElectronicsandCommunications&lab='+heading1+'" class="sidebar-a" > <h3 class="text-h3-darkblue" style="margin-top: 2px;">Feedback</h3></a>'
sectionNumber=1
while sectionNumber<=len(sectionno):
	tag=""
	tag=""
