...
var bitadder = function()
{
	...
	this.calculate = function ()
	{
		var input1=this.switches[0].status;
		var input2=this.switches[1].status;
		var input3=this.switches[2].status;
		var input4=this.switches[3].status;
		//Cout= AB + CB + AC
...
var bitaddersubtracter = function()
{
	...
	this.calculate = function ()
	{
		...
		var a2=this.switches[4].status;
		var b2=this.switches[5].status;
		var a3=this.switches[6].status;
		var b3=this.switches[7].status;
		var cout=this.switches[8].status;
		
		var s0 = a0 && ((!b0 && cout) || (b0 && !cout))
...
this.switches = [];
	...
	this.calculate = function ()
	{
		...
		var b1=(this.switches[1].status!= null)? this.switches[1].status : false;
		var b2=(this.switches[2].status!= null)? this.switches[2].status : false;
		var b3 = (this.switches[3].status!= null)? this.switches[2].status : false;
		
		//var e0 = b0 || b1 && (b2 || b3);
		var e0 = !b0;
		//var e1 = !b1&& (b2 || b3) || b1 && !(b2 || b3);
		var e1=(b1&&b0)||(!b0&&!b1);
		//var e2 = (!b2 && !b3) || !(b2 || b3)
		var e2=(!b2 && b1) || (b0 ||  b2) && (!b1 && !b0);
		//var e3 = b3;
		var e3 = b3 ||  b2 && b1 || b0 ; 
		
		var b = (((b0)?1:0) * 1) + (((b1)?1:0) * 2) + (((b2)?1:0) * 4) + (((b3)?1:0) * 8);
		$("#b_bcdtoexcess").html(b)
		var e = (((e0)?1:0) * 1) + (((e1)?1:0) * 2) + (((e2)?1:0) * 4) + (((e3)?1:0) * 8);
		alert(e)
		$("#e_bcdtoexcess").html(e)
		
		if(e0 ==true)
		document.getElementById("e0_bcdtoe3").src = "lightbulb1left.png"
		else
		document.getElementById("e0_bcdtoe3").src = "lightbulbleft.png"
		if(e1 ==true)
		document.getElementById("e1_bcdtoe3").src = "lightbulb1left.png"
		else
		document.getElementById("e1_bcdtoe3").src = "lightbulbleft.png"
		if(e2 ==true)
		document.getElementById("e2_bcdtoe3").src = "lightbulb1left.png"
		else
		document.getElementById("e2_bcdtoe3").src = "lightbulbleft.png"
		if(e3 ==true)
		document.getElementById("e3_bcdtoe3").src = "lightbulb1left.png"
		else
...
this.switches = [];
	...
	this.calculate = function ()
	{
		...
		var z = (this.switches[3].status!= null)? this.switches[2].status : false;
		
		var b0 = (w && x && !y && !z)|| (w && !x && y && z )
		var b1 = (w && !x && !z) || (w && !x  && !y) || (!w && x && y && z) 
		var b2 = ( !y && z) || ( y && !z) ;
		var b3 =  (!z && 1) || (z && 0)
		...
		if(b0 ==true)
		document.getElementById("b0_excesstobcd").src = "lightbulb1left.png"
		else
		document.getElementById("b0_excesstobcd").src = "lightbulbleft.png"
		if(b1 ==true)
		document.getElementById("b1_excesstobcd").src = "lightbulb1left.png"
		else
		document.getElementById("b1_excesstobcd").src = "lightbulbleft.png"
		if(b2 ==true)
		document.getElementById("b2_excesstobcd").src = "lightbulb1left.png"
		else
		document.getElementById("b2_excesstobcd").src = "lightbulbleft.png"
		if(b3 ==true)
		document.getElementById("b3_excesstobcd").src = "lightbulb1left.png"
		else
...
var binarycounter = function()
{
	...
	{	
		var b = bin[counter].split("")
		//console.log(b[3]+"  "+b[2]+"  "+b[1]+"  "+b[0])
		$("#decimaloutput_bc").text(counter)
		if(b[3] ==true)
...
var bcdcounter = function()
{
	...
	{	
		var b = bin[counter].split("")
		//console.log(b[3]+"  "+b[2]+"  "+b[1]+"  "+b[0])
		$("#decimaloutput_bcd").text(counter)
		if(b[3] ==true)
...
var johncounter = function()
{
	...
	var x,bin = [],counter = 0;
	var time;
	var data = new Array(8,12,14,15,7,3,1,0);
	this.init = function(){
...
this.com = function(val)
{
	...
	this.calculate = function ()
	{
		...
		//binary conversion
			...
			var a_bin = this.deciToBin(a);
			alert("a_bin: "+a_bin);
			//var b_bin = b.toString(2);
			var b_bin = this.deciToBin(b);
			alert("b_bin :"+b_bin);
		//1's compliment
		...
		//abar to decimal
			...
			if(!s3 && !s2 && !s1 && !s0){alert("1:"+a_bar_deci)
					y = a_bar_deci
			}
			else if(!s3 && !s2 && !s1 && s0)
					y = (that.toggleBits((a+b).toString(2))).toString(2) 
			else if(!s3 && !s2 && s1 && !s0)
					y = a_bar_deci * b
			else if(!s3 && !s2 && s1 && s0)
					y = 0;
		...
		$("#y_a").html("Y: "+y);
		if(y_bin[3] ==true)
		document.getElementById("y3_alu_arithmetic").src = "lightbulb1_up.png"
		else
		document.getElementById("y3_alu_arithmetic").src = "lightbulb_up.png"
		if(y_bin[2] ==true)
		document.getElementById("y2_alu_arithmetic").src = "lightbulb1_up.png"
		else
		document.getElementById("y2_alu_arithmetic").src = "lightbulb_up.png"
		if(y_bin[1] ==true)
		document.getElementById("y1_alu_arithmetic").src = "lightbulb1_up.png"
		else
		document.getElementById("y1_alu_arithmetic").src = "lightbulb_up.png"
		if(y_bin[0] ==true)
		document.getElementById("y0_alu_arithmetic").src = "lightbulb1_up.png"
		else
		document.getElementById("y0_alu_arithmetic").src = "lightbulb_up.png"
	}
...
this.deciToBin1 = function(arg)
{
	...
	this.calculate = function ()
	{
		...
		//binary conversion
			//var a_bin = a.toString(2);
			var a_bin = this.deciToBin1(a_bin);
			alert("a_bin: "+a_bin);
			//var b_bin = b.toString(2);
			var b_bin = this.deciToBin1(b_bin);
			alert("b_bin :"+b_bin);
		//1's compliment
			var a_bar = this.toggleBits(a_bin);
			alert("a_bar: "+a_bar);
...
var encoder = function()
{
	...
	this.calculate = function ()
	{
		...
		$("#a_encoder").html((A0?1:0)+""+(A1?1:0)+""+(A2?1:0)+""+(A3?1:0));
		if(A0 ==true)
...
var decoder = function()
{
	...
	this.calculate = function ()
	{
		...
		var q6 = s2 && s1 && !s0
		var q7 = s2 && s1 && s0
		$("#s_decoder").html((s0?1:0)+""+(s1?1:0)+""+(s2?1:0));
...
var Monostable = function()
{
 ...
 $(document).ready(function(){ 
	...
	//alu_arithmetic
	{
		...
		$(function(){
		$("#cn_a").click( function(){
		obj_alu_arithmetic.switch_status("cn_a",0)
		})
		$("#a3_a").click( function(){
		...
		obj_alu_arithmetic.switch_status("mode_a",12)
		})
		});
	}
	//alu_logic
	{
		...
		$("#mode_l").click( function(){
		obj_alu_logic.switch_status("mode_l",12)
		});
		});
	}
	//binarytogray
