 ...
 $(document).ready(function(){ 
	...
	
	{
		...
		$("#clear_button_hadd").click(function (){
			...
			$("#sum").attr("src","images/lightbulb.png");
			$("#sum_text").val(0);
			
			$("#carry").attr("src","images/lightbulb.png");
			$("#carry_text").val(0);
		})
	}
	{
		...
		$("#clear_button_fadd").click(function (){
			...
			$("#sum_fulladder").attr("src","images/lightbulb.png");
			$("#sum_fulladder_text").val(0);
			
			$("#carry_fulladder").attr("src","images/lightbulb.png");
	...
	
	{
		...
		$("#clear_button_2bitadd").click(function (){
			...
			$("#carry_2bit").attr("src","images/lightbulb.png");
			$("#carry_2bit_text").val(0);
			
			$("#sum2_2bit").attr("src","images/lightbulb.png");
			$("#sum2_2bit_text").val(0);
			
			$("#sum1_2bit").attr("src","images/lightbulb.png");
	...
	
	{
		...
		$("#clear_button_hsub").click(function (){
			...
			$("#sum_halfsub").attr("src","images/lightbulb.png");
			$("#sum_halfsub_text").val(0);
			
			$("#carry_halfsub").attr("src","images/lightbulb.png");
	...
	}
	{
		...
		$("#clear_button_fsub").click(function (){
			...
			$("#sum_fullsub").attr("src","images/lightbulb.png");
			$("#sum_fullsub_text").val(0);
			
			$("#carry_fullsub").attr("src","images/lightbulb.png");
	...
	
	{
		...
		$("#clear_button_4addsub").click(function (){
			...
			for(var i=0;i<=3;i++){
				$("#s"+i+"_4bit").attr("src","images/lightbulb.png");
				$("#s"+i+"_4bit_text").val(0);
			}
			
			$("#carry_4bit").attr("src","images/lightbulb.png");
